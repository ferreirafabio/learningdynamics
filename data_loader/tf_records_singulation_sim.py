...
if __name__ == '__main__':
    ...
    create_tfrecords_from_dir(config, "/scr2/seg_dir_overfit_dataset_1_sample", "/scr2/fabiof/data/tfrecords_overfit_dataset_1_sample_3_objects_15_rollouts_padded", test_size=0.0, n_sequences_per_batch=100, pad_to=15, use_fixed_rollout=None)
