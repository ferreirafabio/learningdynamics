...
class DataGenerator:
    def __init__(self, config, train=True):
        ...
        self.dataset = self.dataset.padded_batch(4, padded_shapes=((None, 120, 160, 3),
                                                                   (None, 120, 160),
                                                                   (None, 3)))
                                                                    #(None, 120, 160, 4))
    ...
    def _parse_function(self, example_proto):
        context_features = {
            ...
            #'gripperpos': tf.FixedLenSequenceFeature([], tf.string, allow_missing=True),
        ...
        return img,seg, gripperpos, experiment_id, n_total_objects, n_manipulable_objects