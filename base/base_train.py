...
class BaseTrain:
    ...
    def initialize_model(self):
        ...
        self.out_image_tf, self.model.latent_init_img_train = self.model.cnnmodel(self.in_image_tf, self.in_segxyz_tf, self.in_control_tf, is_training=self.is_training)
