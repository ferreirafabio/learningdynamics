    ...
    def __init__(self, name="MLPGraphIndependent"):
        ...
        with self._enter_variable_scope():
            self._network = modules.GraphIndependent(
                edge_model_fn=EncodeProcessDecode_v1.make_mlp_model_edges,
                node_model_fn=EncodeProcessDecode_v1.make_mlp_model,
                global_model_fn=EncodeProcessDecode_v1.make_mlp_model
            )
...
class CNNDecoderGraphIndependent(snt.AbstractModule):
    ...
    def __init__(self, model_id, name="CNNDecoderGraphIndependent"):
        ...
        with self._enter_variable_scope():
            ...
            self._network = modules.GraphIndependent(
                edge_model_fn=EncodeProcessDecode_v1.make_mlp_model_edges_decode,
...
class MLPGraphNetwork(snt.AbstractModule):
    ...
    def __init__(self, name="MLPGraphNetwork"):
        ...
        with self._enter_variable_scope():
          self._network = modules.GraphNetwork(EncodeProcessDecode_v1.make_mlp_model_edges,
                                               EncodeProcessDecode_v1.make_mlp_model,
                                               EncodeProcessDecode_v1.make_mlp_model)
...
class EncodeProcessDecode_v1(snt.AbstractModule, BaseModel):
  ...
  Input --->| Encoder |  *->| Core |--*->| Decoder |---> Output(t)
    ...
    def __init__(self, config, name="EncodeProcessDecode"):
        ...
        EncodeProcessDecode_v1.n_neurons_edges = config.n_neurons_edges
        EncodeProcessDecode_v1.n_layers_edges = config.n_layers_edges
        EncodeProcessDecode_v1.convnet_pooling = config.convnet_pooling
        EncodeProcessDecode_v1.convnet_tanh = config.convnet_tanh
        EncodeProcessDecode_v1.depth_data_provided = config.depth_data_provided
        EncodeProcessDecode_v1.n_neurons_mlp_nonvisual = config.n_neurons_mlp_nonvisual
        EncodeProcessDecode_v1.n_conv_filters = config.n_conv_filters
        EncodeProcessDecode_v1.edge_output_size = config.edge_output_size
        EncodeProcessDecode_v1.model_type = config.model_type
    ...
    def make_mlp_model():
        ...
        """
        return snt.Sequential([snt.nets.MLP([EncodeProcessDecode_v1.dimensions_latent_repr] * EncodeProcessDecode_v1.n_layers, activate_final=True),
                               snt.LayerNorm()])
    ...
    def make_mlp_model_edges_decode():
        ...
        Returns:
          A Sonnet module which contains the MLP and LayerNorm.
        """
        net = snt.nets.MLP([EncodeProcessDecode_v1.n_neurons_edges] * EncodeProcessDecode_v1.n_layers_edges, activate_final=True)
        return snt.Sequential([net, snt.Linear(EncodeProcessDecode_v1.edge_output_size, name="edge_output")])
...
class NonVisualDecoder(snt.AbstractModule):
    ...
    def _build(self, inputs, is_training=True):
        ...
        non_visual_decoded_output = snt.Sequential([snt.nets.MLP([EncodeProcessDecode_v1.n_neurons_mlp_nonvisual, n_non_visual_elements], activate_final=True), snt.LayerNorm()])(non_visual_latent_output)
...
class NonVisualEncoder(snt.AbstractModule):
    ...
    def _build(self, inputs, is_training=True):
        ...
        non_visual_latent_output = snt.Sequential([snt.nets.MLP([n_non_visual_elements, EncodeProcessDecode_v1.n_neurons_mlp_nonvisual], activate_final=True), snt.LayerNorm()])(non_visual_elements)
