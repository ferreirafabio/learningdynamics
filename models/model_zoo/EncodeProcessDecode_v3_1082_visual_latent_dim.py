...
class EncodeProcessDecode_v3_1082_visual_latent_dim(snt.AbstractModule, BaseModel):
    """
  ...
  Input --->| Encoder |  *->| Core |--*->| Decoder |---> Output(t)
    ...
    def __init__(self, config, name="EncodeProcessDecode"):
        ...
        super(EncodeProcessDecode_v3_1082_visual_latent_dim, self).__init__(name=name)

        EncodeProcessDecode_v3_1082_visual_latent_dim.convnet_pooling = config.convnet_pooling
        EncodeProcessDecode_v3_1082_visual_latent_dim.convnet_tanh = config.convnet_tanh
        EncodeProcessDecode_v3_1082_visual_latent_dim.depth_data_provided = config.depth_data_provided
        EncodeProcessDecode_v3_1082_visual_latent_dim.n_conv_filters = config.n_conv_filters
        EncodeProcessDecode_v3_1082_visual_latent_dim.model_id = config.model_type
        EncodeProcessDecode_v3_1082_visual_latent_dim.latent_state_noise = config.latent_state_noise

        EncodeProcessDecode_v3_1082_visual_latent_dim.edge_output_size = config.edge_output_size
        EncodeProcessDecode_v3_1082_visual_latent_dim.node_output_size = config.node_output_size
        EncodeProcessDecode_v3_1082_visual_latent_dim.global_output_size = config.global_output_size

        EncodeProcessDecode_v3_1082_visual_latent_dim.n_layers_globals = config.n_layers_globals
        EncodeProcessDecode_v3_1082_visual_latent_dim.n_layers_nodes = config.n_layers_nodes
        EncodeProcessDecode_v3_1082_visual_latent_dim.n_layers_edges = config.n_layers_edges
        EncodeProcessDecode_v3_1082_visual_latent_dim.n_neurons_edges = config.n_neurons_edges
        EncodeProcessDecode_v3_1082_visual_latent_dim.n_neurons_globals = config.n_neurons_globals
        EncodeProcessDecode_v3_1082_visual_latent_dim.n_neurons_nodes_non_visual = config.n_neurons_nodes_non_visual
        EncodeProcessDecode_v3_1082_visual_latent_dim.n_neurons_nodes_total_dim = config.n_neurons_nodes_total_dim
        ...
        with self._enter_variable_scope():
            self._network = modules.GraphIndependent(
                ...
                global_model_fn=lambda: get_model_from_config(self.model_id, model_type="mlp")(
                                                                                        n_neurons=EncodeProcessDecode_v3_1082_visual_latent_dim.n_neurons_globals,
                                                                                        n_layers=EncodeProcessDecode_v3_1082_visual_latent_dim.n_layers_globals,
                                                                                        output_size=None,
                                                                                        typ="mlp_layer_norm",
    ...
    def _build(self, inputs, is_training, verbose=VERBOSITY):
        ...
        self._network = modules.GraphIndependent(
            edge_model_fn=lambda: get_model_from_config(self.model_id, model_type="mlp")(
                                                                                         n_neurons=EncodeProcessDecode_v3_1082_visual_latent_dim.n_neurons_edges,
                                                                                         n_layers=EncodeProcessDecode_v3_1082_visual_latent_dim.n_layers_edges,
                                                                                         output_size=None, typ="mlp_layer_norm",
    ...
    def _build(self, inputs, is_training, verbose=VERBOSITY):
        ...
        self._network = modules.GraphIndependent(
            edge_model_fn=lambda: get_model_from_config(model_id=self.model_id, model_type="mlp")(
                                                                                            n_neurons=EncodeProcessDecode_v3_1082_visual_latent_dim.n_neurons_edges,
                                                                                            n_layers=EncodeProcessDecode_v3_1082_visual_latent_dim.n_layers_edges,
                                                                                            output_size=EncodeProcessDecode_v3_1082_visual_latent_dim.edge_output_size,
                                                                                            typ="mlp_transform",
            ...
            global_model_fn=lambda: get_model_from_config(model_id=self.model_id, model_type="mlp")(
                                                                                                    n_neurons=EncodeProcessDecode_v3_1082_visual_latent_dim.n_neurons_globals,
                                                                                                    n_layers=EncodeProcessDecode_v3_1082_visual_latent_dim.n_layers_globals,
                                                                                                    output_size=EncodeProcessDecode_v3_1082_visual_latent_dim.global_output_size,
                                                                                                    typ="mlp_transform",
    ...
    def __init__(self, model_id, name="MLPGraphNetwork"):
        ...
        with self._enter_variable_scope():
          self._network = modules.GraphNetwork(
              edge_model_fn=lambda: get_model_from_config(model_id, model_type="mlp")(n_neurons=EncodeProcessDecode_v3_1082_visual_latent_dim.n_neurons_edges,
                                                                                      n_layers=EncodeProcessDecode_v3_1082_visual_latent_dim.n_layers_edges,
                                                                                      output_size=None,
                                                                                      typ="mlp_layer_norm",
                                                                                      name="mlp_core_edge"),
              node_model_fn=lambda: get_model_from_config(model_id, model_type="mlp")(n_neurons=EncodeProcessDecode_v3_1082_visual_latent_dim.n_neurons_nodes_total_dim,
                                                                                      n_layers=EncodeProcessDecode_v3_1082_visual_latent_dim.n_layers_nodes,
                                                                                      output_size=None,
                                                                                      typ="mlp_layer_norm",
                                                                                      name="mlp_core_node"),
              global_model_fn=lambda: get_model_from_config(model_id, model_type="mlp")(n_neurons=EncodeProcessDecode_v3_1082_visual_latent_dim.n_neurons_globals,
                                                                                        n_layers=EncodeProcessDecode_v3_1082_visual_latent_dim.n_layers_globals,
                                                                                        output_size=None,
                                                                                        typ="mlp_layer_norm",
...
class Decoder5LayerConvNet2D(snt.AbstractModule):
    ...
    def _build(self, inputs, name, verbose=VERBOSITY, keep_dropout_prop=0.6):
        ...
        img_shape = get_correct_image_shape(config=None, get_type='all', depth_data_provided=EncodeProcessDecode_v3_1082_visual_latent_dim.depth_data_provided)

        """ get image data, get everything >except< last n elements which are non-visual (position and velocity) """
        image_data = inputs[:, :-EncodeProcessDecode_v3_1082_visual_latent_dim.n_neurons_nodes_non_visual]
...
class Encoder5LayerConvNet2D(snt.AbstractModule):
    ...
    def _build(self, inputs, name, verbose=VERBOSITY, keep_dropout_prop=0.6):
        ...
        ''' layer 3'''
        if EncodeProcessDecode_v3_1082_visual_latent_dim.convnet_pooling:
        ...
        ''' layer 11'''
        visual_latent_output = tf.layers.dense(inputs=visual_latent_output, units=EncodeProcessDecode_v3_1082_visual_latent_dim.n_neurons_nodes_total_dim - EncodeProcessDecode_v3_1082_visual_latent_dim.n_neurons_nodes_non_visual)
        return visual_latent_output
...
class VisualAndLatentDecoder(snt.AbstractModule):
    ...
    def _build(self, inputs, is_training=True, verbose=VERBOSITY):
        ...
        non_visual_decoded_output = snt.Sequential([snt.nets.MLP([EncodeProcessDecode_v3_1082_visual_latent_dim.n_neurons_nodes_total_dim, n_non_visual_elements],
...
class VisualAndLatentEncoder(snt.AbstractModule):
    ...
    def _build(self, inputs, verbose=VERBOSITY):
        ...
        non_visual_latent_output = snt.Sequential([snt.nets.MLP([n_non_visual_elements, EncodeProcessDecode_v3_1082_visual_latent_dim.n_neurons_nodes_non_visual],
