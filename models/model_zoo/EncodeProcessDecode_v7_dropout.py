...
class EncodeProcessDecode_v7_dropout(snt.AbstractModule, BaseModel):
    """
  ...
  Input --->| Encoder |  *->| Core |--*->| Decoder |---> Output(t)
    ...
    def __init__(self, config, name="EncodeProcessDecode"):
        ...
        super(EncodeProcessDecode_v7_dropout, self).__init__(name=name)

        EncodeProcessDecode_v7_dropout.convnet_pooling = config.convnet_pooling
        EncodeProcessDecode_v7_dropout.convnet_tanh = config.convnet_tanh
        EncodeProcessDecode_v7_dropout.depth_data_provided = config.depth_data_provided
        EncodeProcessDecode_v7_dropout.n_conv_filters = config.n_conv_filters
        EncodeProcessDecode_v7_dropout.model_id = config.model_type
        EncodeProcessDecode_v7_dropout.latent_state_noise = config.latent_state_noise

        EncodeProcessDecode_v7_dropout.edge_output_size = config.edge_output_size
        EncodeProcessDecode_v7_dropout.node_output_size = config.node_output_size
        EncodeProcessDecode_v7_dropout.global_output_size = config.global_output_size

        EncodeProcessDecode_v7_dropout.n_layers_globals = config.n_layers_globals
        EncodeProcessDecode_v7_dropout.n_layers_nodes = config.n_layers_nodes
        EncodeProcessDecode_v7_dropout.n_layers_edges = config.n_layers_edges
        EncodeProcessDecode_v7_dropout.n_neurons_edges = config.n_neurons_edges
        EncodeProcessDecode_v7_dropout.n_neurons_nodes = config.n_neurons_nodes
        EncodeProcessDecode_v7_dropout.n_neurons_globals = config.n_neurons_globals
        EncodeProcessDecode_v7_dropout.n_neurons_nodes_non_visual = config.n_neurons_nodes_non_visual
        EncodeProcessDecode_v7_dropout.conv_layer_instance_norm = config.conv_layer_instance_norm
        ...
        with self._enter_variable_scope():
            self._network = modules.GraphIndependent(
                ...
                global_model_fn=lambda: get_model_from_config(self.model_id, model_type="mlp")(
                                                                                        n_neurons=EncodeProcessDecode_v7_dropout.n_neurons_globals,
                                                                                        n_layers=EncodeProcessDecode_v7_dropout.n_layers_globals,
                                                                                        output_size=None,
    ...
    def _build(self, inputs, is_training, verbose=VERBOSITY):
        self._network = modules.GraphIndependent(
            edge_model_fn=lambda: get_model_from_config(self.model_id, model_type="mlp")(
                                                                n_neurons=EncodeProcessDecode_v7_dropout.n_neurons_edges,
                                                                n_layers=EncodeProcessDecode_v7_dropout.n_layers_edges,
                                                                output_size=None,
                                                                typ="mlp_layer_norm",
                                                                activation_final=False,
    ...
    def _build(self, inputs, is_training, verbose=VERBOSITY):
        self._network = modules.GraphIndependent(
            edge_model_fn=lambda: get_model_from_config(model_id=self.model_id, model_type="mlp")(
                                                        n_neurons=EncodeProcessDecode_v7_dropout.n_neurons_edges,
                                                        n_layers=EncodeProcessDecode_v7_dropout.n_layers_edges,
                                                        output_size=EncodeProcessDecode_v7_dropout.edge_output_size,
                                                        typ="mlp_transform",
                                                        activation_final=False,
            ...
            global_model_fn=lambda: get_model_from_config(model_id=self.model_id, model_type="mlp")(
                                                        n_neurons=EncodeProcessDecode_v7_dropout.n_neurons_globals,
                                                        n_layers=EncodeProcessDecode_v7_dropout.n_layers_globals,
                                                        output_size=EncodeProcessDecode_v7_dropout.global_output_size,
                                                        typ="mlp_transform",
                                                        activation_final=False,
    ...
    def __init__(self, model_id, name="MLPGraphNetwork"):
        ...
        with self._enter_variable_scope():
          self._network = modules.GraphNetwork(
              edge_model_fn=lambda: get_model_from_config(model_id, model_type="mlp")(n_neurons=EncodeProcessDecode_v7_dropout.n_neurons_edges,
                                                                                      n_layers=EncodeProcessDecode_v7_dropout.n_layers_edges,
                                                                                      output_size=None,
                                                                                      typ="mlp_layer_norm",
                                                                                      name="mlp_core_edge"),
              node_model_fn=lambda: get_model_from_config(model_id, model_type="mlp")(n_neurons=EncodeProcessDecode_v7_dropout.n_neurons_nodes,
                                                                                      n_layers=EncodeProcessDecode_v7_dropout.n_layers_nodes,
                                                                                      output_size=None,
                                                                                      typ="mlp_layer_norm",
                                                                                      activation_final=False,
                                                                                      name="mlp_core_node"),

              global_model_fn=lambda: get_model_from_config(model_id, model_type="mlp")(n_neurons=EncodeProcessDecode_v7_dropout.n_neurons_globals,
                                                                                        n_layers=EncodeProcessDecode_v7_dropout.n_layers_globals,
                                                                                        output_size=None,
                                                                                        typ="mlp_layer_norm",
...
class SmallEdgeEncoder(snt.AbstractModule):
    ...
    def _build(self, inputs, verbose=VERBOSITY):
        ...
        img_shape = get_correct_image_shape(config=None, get_type="seg",
                                            depth_data_provided=EncodeProcessDecode_v7_dropout.depth_data_provided)
...
class VisualAndLatentDecoderSonnet(snt.AbstractModule):
    ...
    def _build(self, inputs, verbose=VERBOSITY, keep_dropout_prop=0.9):
        filter_sizes = [EncodeProcessDecode_v7_dropout.n_conv_filters,
                        EncodeProcessDecode_v7_dropout.n_conv_filters * 2]
        ...
        non_visual_latent_output = inputs[:, -EncodeProcessDecode_v7_dropout.n_neurons_nodes_non_visual:]

        # Transforms the outputs into the appropriate shape.
        """ map latent position/velocity (nodes) from 32d to original 6d space """
        n_neurons = EncodeProcessDecode_v7_dropout.n_neurons_nodes_non_visual
        n_layers = 2
...
class VisualAndLatentEncoderSonnet(snt.AbstractModule):
    ...
    def _build(self, inputs, verbose=VERBOSITY, keep_dropout_prop=0.9):
        ...
        if EncodeProcessDecode_v7_dropout.convnet_pooling:
        ...
        n_neurons = EncodeProcessDecode_v7_dropout.n_neurons_nodes_non_visual
        n_layers = EncodeProcessDecode_v7_dropout.n_neurons_nodes_non_visual
        output_size = EncodeProcessDecode_v7_dropout.n_neurons_nodes_non_visual
        net = snt.nets.MLP([n_neurons] * n_layers, activate_final=False)
