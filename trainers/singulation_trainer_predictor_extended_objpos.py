...
class SingulationTrainerPredictorExtendedObjPosition(BaseTrain):
    def __init__(self, sess, model, train_data, valid_data, config, logger, only_test):
        super(SingulationTrainerPredictorExtendedObjPosition, self).__init__(sess, model, train_data, valid_data, config, logger, only_test)
    ...
    def train_batch(self, prefix):
        ...
        _, loss_img, loss_perception, loss_pos, out_predictions, in_rgb_seg_xyz, out_encoder_vectors = self.sess.run([self.model.train_op,
                                                                                                  self.model.img_loss,
                                                                                                  self.model.perception_loss,
                                                                                                  self.model.objpos_loss,
